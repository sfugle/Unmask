...
public:
	...
	bool SetBoneTrackKeys(FName BoneName, const TArray<FUMJointKey>& Keys); //not an override
	...
	bool SetTransformCurveKeys(const FAnimationCurveIdentifier& CurveId, const TArray<FUMJointKey>& Timeline); //not an override
